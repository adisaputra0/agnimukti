...
<main class="flex-1 p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-xl border border-[#BFC3B1] p-5">
            ...
            <p class="text-xs text-[#5B4636] mt-1">Standar, Premium, Tambahan</p>
        </div>
        ...
        <div class="bg-white rounded-xl border border-[#BFC3B1] p-5">
            ...
            <p class="text-3xl font-semibold text-[#2B221D]">Rp 8 Jt</p>
            <p class="text-xs text-[#5B4636] mt-1">Paket Kremasi VIP</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl border border-[#BFC3B1]">
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-[#D8D2C6]">
                    ...
                    <tr class="hover:bg-[#F5F1EC] transition-colors">
                        ...
                        <td class="px-5 py-4">
                            <div>
                                <p class="font-medium text-[#2B221D]">Paket Kremasi Standar</p>
                                <p class="text-xs text-[#5B4636] font-mono mt-0.5">ID: PKT001</p>
                            </div>
                        </td>
                        <td class="px-5 py-4">
                    ...
                    <tr class="hover:bg-[#F5F1EC] transition-colors">
                        ...
                        <td class="px-5 py-4">
                            <div>
                                <p class="font-medium text-[#2B221D]">Paket Kremasi VIP</p>
                                <p class="text-xs text-[#5B4636] font-mono mt-0.5">ID: PKT004</p>
                            </div>
                        </td>
                        <td class="px-5 py-4">
                            <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-[#BFC3B1] text-[#2B221D]">
                                Premium
                            </span>
                        </td>
                        <td class="px-5 py-4 text-[#5B4636] max-w-xs">
                    ...
                    <tr class="hover:bg-[#F5F1EC] transition-colors">
                        ...
                        <td class="px-5 py-4">
                            <div>
                                <p class="font-medium text-[#2B221D]">Dokumentasi Foto & Video</p>
                                <p class="text-xs text-[#5B4636] font-mono mt-0.5">ID: PKT005</p>
                            </div>
                        </td>
                        <td class="px-5 py-4">
                            <span class="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-[#E8DDD0] text-[#5B4636]">
        ...
        <div class="px-5 py-4 border-t border-[#D8D2C6] flex items-center justify-between">
            <p class="text-xs text-[#5B4636]">Menampilkan 3 dari 6 paket layanan</p>
            <div class="flex items-center gap-1">
                ...
                <button class="px-3 py-1.5 text-xs text-[#5B4636] border border-[#BFC3B1] rounded-lg hover:bg-[#F5F1EC]">2</button>
    ...
    <div class="bg-white rounded-xl border border-[#BFC3B1] w-full max-w-lg mx-4 shadow-xl">
        ...
        <div class="px-6 py-5 space-y-4">
            <div>
                ...
                <select class="w-full px-3 py-2 text-sm border border-[#BFC3B1] rounded-lg bg-white text-[#2B221D] focus:outline-none focus:ring-2 focus:ring-[#B86E4B]/30 focus:border-[#B86E4B]">
                    <option value="">Pilih Kategori</option>
                    <option value="1">Kremasi</option>
                    <option value="2">Ngaben</option>
                    <option value="3">Pelayanan Adat</option>
                </select>
            </div>
            ...
            <div>
                ...
                <input type="number" placeholder="Masukkan harga paket"
                    class="w-full px-3 py-2 text-sm border border-[#BFC3B1] rounded-lg bg-white text-[#2B221D] placeholder-[#5B4636]/50 focus:outline-none focus:ring-2 focus:ring-[#B86E4B]/30 focus:border-[#B86E4B]">
            </div>

            <div>
                <label class="block text-xs font-medium text-[#5B4636] mb-1.5">Fasilitas</label>
                <textarea rows="4" placeholder="Masukkan fasilitas paket"
        ...
        <div class="px-6 py-4 border-t border-[#D8D2C6] flex justify-end gap-2 bg-[#F5F1EC] rounded-b-xl">
            ...
            <button class="px-4 py-2 text-sm bg-[#B86E4B] hover:bg-[#B86E4B]/90 text-white rounded-lg transition-colors shadow-sm">
                Simpan
            </button>
        </div>
    </div>
...
<div id="modalEdit" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-[#2B221D]/40 backdrop-blur-sm">
    <div class="bg-white rounded-xl border border-[#BFC3B1] w-full max-w-lg mx-4 shadow-lg">
        <div class="px-6 py-4 border-b border-[#D8D2C6] flex items-center justify-between bg-[#F5F1EC] rounded-t-xl">
            ...
            <button onclick="document.getElementById('modalEdit').classList.add('hidden')" class="text-[#5B4636] hover:text-[#2B221D]">
                <i class="ti ti-x text-lg"></i>
            </button>
        </div>
        ...
        <div class="px-6 py-5 space-y-4">
            <div>
                <label class="block text-xs font-medium text-[#5B4636] mb-1.5">Kategori Paket</label>
                <select class="w-full px-3 py-2 text-sm border border-[#BFC3B1] rounded-lg bg-white text-[#2B221D] focus:outline-none focus:ring-2 focus:ring-[#B86E4B]/30 focus:border-[#B86E4B]">
                    <option value="1" selected>Kremasi</option>
                    <option value="2">Ngaben</option>
                    <option value="3">Pelayanan Adat</option>
                </select>
            </div>
            ...
            <div>
                <label class="block text-xs font-medium text-[#5B4636] mb-1.5">Nama Paket</label>
                <input type="text" value="Paket Kremasi Premium"
            ...
            <div>
                <label class="block text-xs font-medium text-[#5B4636] mb-1.5">Fasilitas</label>
                <textarea rows="4"
                    class="w-full px-3 py-2 text-sm border border-[#BFC3B1] rounded-lg bg-white text-[#2B221D] focus:outline-none focus:ring-2 focus:ring-[#B86E4B]/30 focus:border-[#B86E4B] resize-none">Tempat upacara, transportasi, konsumsi keluarga, dokumentasi.</textarea>
            </div>
        </div>
